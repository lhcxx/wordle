...
{
    public class CheatingWordleClient
    {
        private readonly string _serverAddress;
        private readonly int _port;

        public CheatingWordleClient(string serverAddress = "localhost", int port = 8889)
        {
        ...
        public async Task StartAsync()
        {
            try
            {
                ...
                Console.WriteLine($"Connecting to cheating server at {_serverAddress}:{_port}...");
                
                await client.ConnectAsync(_serverAddress, _port);
                Console.WriteLine("Connected to cheating server!");
            ...
            catch (SocketException ex)
            {
                ...
                Console.WriteLine("Make sure the cheating server is running and the address/port are correct.");
            }
            catch (Exception ex)
            {
